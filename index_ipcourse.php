		  ...
		  <div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
		        ...
		        <li  class="active"><a href="index_ipcourse.php">课程指标点关联矩阵</a></li>
		      </ul>
	...
	?>><?php echo $course_name_list[$i]?>
				<div class='right' style="margin-left:-80px;">
					<a href='javascript:void(0)'>
						<span class='blue margin_left_30 glyphicon glyphicon-pencil hidden' onclick="$('#updateCourse').modal('toggle');$('#update_course_id').val($(event.target).closest('tr').attr('data-xxoo'));">
						</span>
					</a>
					<a href='javascript:void(0)'>
						<span class='red margin_left_30 glyphicon glyphicon-trash hidden' onclick="$('#deleteCourseModal').modal('toggle');$('#del_course_id').val($(event.target).closest('tr').attr('data-xxoo'));">
						</span>
					</a>
				</div>
			</td>
